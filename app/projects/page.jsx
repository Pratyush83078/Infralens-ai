...
export default function Projects() {
  return (
    <Suspense
      fallback={
        <div className="paimana-container" style={{ padding: '80px 20px', textAlign: 'center' }}>
          <div className="neo-card" style={{ maxWidth: 460, margin: '0 auto', padding: '32px' }}>
            <Mascot pose="radar" size={48} />
            <h3 style={{ marginTop: 16, fontFamily: 'var(--font-display)' }}>Loading Project Explorer...</h3>
            <p style={{ color: 'var(--ink-muted)', fontSize: 13, marginTop: 6 }}>
              Fetching telemetry from MoSPI snapshot index
            </p>
          </div>
        </div>
      }
